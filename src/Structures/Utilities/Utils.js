...
import FoldCodes from './FoldCodes';
...
class Utils {
    ...
    async genValidationToken() {
        ...
        // Oh and get a base64 date in milliseconds
        const random = crypto.randomBytes(this.byteSize).toString();
    ...
    async findVerifying(validationToken, userID) {
        const user = await this.evolve.base.db.findVerify({ userID });
        if (!user) {
            return false;
        }
    ...
    async testMirrorURL(url) {
        var _a, _b;
        try {
            const test = await this.evolve.base.superagent.get(`${url}/api`);
            if ((test === null || test === void 0 ? void 0 : test.text) && ((_b = (_a = JSON.parse(test === null || test === void 0 ? void 0 : test.text)) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.res) === 'Pong! Mirror Operational!') {
                return true;
            }
            return false;
        }
    ...
    async determineHomeURL(req) {
        var _a, _b;
        try {
            const test = await this.evolve.base.superagent.get(`${this.evolve.base.options.url}/api`);
            if ((test === null || test === void 0 ? void 0 : test.text) && ((_b = (_a = JSON.parse(test === null || test === void 0 ? void 0 : test.text)) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.message) === 'Pong!') {
